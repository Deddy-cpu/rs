...
<template>
  <AuthenticatedLayout>
    <Head title="Tambah Polis Asuransi" />
    ...
    <div class="min-h-screen bg-cover bg-center p-6" style="background-image: url('/images/bg-login.png')">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-gray-600 text-lg">
          Tambahkan polis asuransi baru ke sistem
        </p>
      </div>
        ...
        <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
          ...
          <div class="bg-gradient-to-r from-blue-500 to-indigo-500 px-8 py-6 text-white">
            <div class="flex items-center gap-4">
              ...
              <div>
                <h2 class="text-2xl font-bold text-white">Form Tambah Polis</h2>
                <p class="text-blue-100">Lengkapi informasi polis asuransi</p>
              </div>
            </div>
          </div>
          ...
          <div class="flex items-start gap-4">
            ...
            <div>
              ...
              <ul class="text-blue-700 space-y-1 text-sm">
                <li>• <strong>Deskripsi Polis:</strong> Gunakan nama yang jelas dan mudah dipahami</li>
                <li>• <strong>Status:</strong> Pilih "Aktif" jika polis dapat digunakan, "Tidak Aktif" jika tidak</li>
