  ...
  <AuthenticatedLayout>
    ...
    >
      ...
      <div class="bg-white/70 backdrop-blur-sm rounded-xl p-6 shadow-lg">
        ...
        <!-- Table -->
        <div
          class="overflow-hidden rounded-xl shadow border border-gray-200 bg-white/70 backdrop-blur-sm"
        >
          <table class="w-full text-sm">
            ...
            <tbody>
              <tr
                ...
                :key="r.id"
                class="odd:bg-white/60 even:bg-blue-50/60 hover:bg-blue-100/70 transition"
              >
