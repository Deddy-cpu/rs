...
const form = useForm({
  grp_eselon_id: props.eselon.grp_eselon_id,
  eselon_desc: props.eselon.eselon_desc,
  aktif: props.eselon.aktif || 'Y',
  update_date: new Date().toISOString().split('T')[0], // Set to current date
...
const submitForm = () => {
  ...
  form.put(route('eselon.update', props.eselon.id), {
    onSuccess: () => {
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
          <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-3">
                ...
                <div>
                  <h1 class="text-2xl font-bold text-gray-900">Edit Eselon</h1>
                  <p class="text-sm text-gray-600">Ubah data eselon</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <form @submit.prevent="submitForm" class="p-6">
            <div class="space-y-6">
              <!-- Grup Eselon -->
              <div>
                <label for="grp_eselon_id" class="block text-sm font-medium text-gray-700 mb-2">
                  Grup Eselon <span class="text-red-500">*</span>
                </label>
                <select
                  id="grp_eselon_id"
