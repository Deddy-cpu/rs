...
const initializeForm = () => {
  if (props.farmalkes && props.farmalkes.id) {
    console.log('Initializing form with farmalkes data:', props.farmalkes)
    
    // Assign form fields directly
    ...
    console.warn('Farmalkes data not available for initialization')
  }
}

// Initialize form when component mounts
onMounted(() => {
  console.log('Component mounted, props.farmalkes:', props.farmalkes)
  initializeForm()
})

// Watch for changes in farmalkes prop
watch(() => props.farmalkes, (newFarmalkes) => {
  console.log('Props.farmalkes changed:', newFarmalkes)
  if (newFarmalkes) {
    initializeForm()
  }
...
const submitForm = () => {
  ...
  // Check if farmalkes exists and has an id
  if (!props.farmalkes || !props.farmalkes.id) {
    console.error('Farmalkes data is missing or invalid')
    return
  }
  
  console.log('Submitting form with data:', form.data())
  console.log('Farmalkes ID:', props.farmalkes.id)
  
  form.put(route('farmalkes.update', { farmalke: props.farmalkes.id }), {
    onSuccess: () => {
  ...
  <AuthenticatedLayout>
    ...
    <div class="min-h-screen bg-cover bg-center p-6" style="background-image: url('/images/bg-login.png')">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-gray-600 text-lg">Ubah data farmasi dan alat kesehatan</p>
      </div>
        ...
        <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
          ...
          <div class="bg-gradient-to-r from-red-600 to-rose-600 px-8 py-6 text-white">
            <div class="flex items-center gap-4">
              ...
              <div>
                <h2 class="text-2xl font-bold">Form Edit Farmalkes</h2>
                <p class="text-red-100">Perbarui data farmasi dan alat kesehatan di bawah ini</p>
              </div>
            </div>
          </div>
          ...
          <div class="p-8">
            <form @submit.prevent="submitForm" class="space-y-8">
              ...
              <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
                ...
                <button
                  type="submit"
                  :disabled="form.processing || !props.farmalkes || !props.farmalkes.id"
