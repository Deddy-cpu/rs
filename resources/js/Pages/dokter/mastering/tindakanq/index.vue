    ...
    <div class="min-h-screen bg-gray-50 py-6">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-3">
                ...
                <div>
                  <h1 class="text-2xl font-bold text-gray-900">Data Tindakan Q</h1>
                  <p class="text-sm text-gray-600">Kelola data tindakan medis</p>
                </div>
              </div>
              <button
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <tr v-if="records.length === 0">
                  <td colspan="6" class="px-6 py-12 text-center">
                    <div class="flex flex-col items-center">
                      <i class="fas fa-procedures text-gray-300 text-4xl mb-4"></i>
                ...
                <tr v-for="(record, idx) in records" :key="record.id" class="hover:bg-gray-50">
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    {{ (props.tindakanQs.current_page - 1) * props.tindakanQs.per_page + idx + 1 }}
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm font-medium text-gray-900">{{ record.tindakan_q_desc }}</div>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap">
                    <span 
          ...
          <!-- Pagination -->
          <div v-if="props.tindakanQs.links && props.tindakanQs.links.length > 3" class="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
            <div class="flex-1 flex justify-between sm:hidden">
              <Link
                v-if="props.tindakanQs.links[0].url"
                :href="props.tindakanQs.links[0].url"
                class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"
              >
                Previous
              </Link>
              <Link
                v-if="props.tindakanQs.links[props.tindakanQs.links.length - 1].url"
                :href="props.tindakanQs.links[props.tindakanQs.links.length - 1].url"
