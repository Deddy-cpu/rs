  ...
  <AuthenticatedLayout>
    ...
    <div class="min-h-screen bg-cover bg-center p-6" style="background-image: url('/images/bg-login.png')">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-gray-600 text-lg">Perbarui data tindakan medis</p>
      </div>
      ...
      <div class="max-w-4xl mx-auto">
        <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
          ...
          <div class="bg-gradient-to-r from-green-500 to-emerald-500 px-8 py-6 text-white">
            <div class="flex items-center gap-4">
              ...
              <div>
                <h2 class="text-2xl font-bold">Form Edit Tindakan Q</h2>
                <p class="text-green-100">Perbarui informasi tindakan medis di bawah ini</p>
              </div>
            </div>
          </div>
          ...
          <div class="p-8">
            <form @submit.prevent="submitForm" class="space-y-8">
              <!-- Deskripsi -->
              <div class="space-y-2">
                <label for="tindakan_q_desc" class="block text-sm font-semibold text-gray-700">
                  <svg class="w-4 h-4 inline mr-2 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6M7 8h10M5 4h14" />
                  </svg>
                ...
                <input
                  ...
                  class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent bg-gray-50 focus:bg-white text-lg transition-all duration-200"
                  :class="{ 'border-red-500 focus:ring-red-500': form.errors.tindakan_q_desc }"
                />
                <div v-if="form.errors.tindakan_q_desc" class="text-red-600 text-sm mt-1 flex items-center">
              ...
              <div class="space-y-2">
                ...
                <input
                  ...
                  type="date"
                  required
                  class="w-full px-4 py-3 border border-gray-300 rounded-xl bg-gray-50 focus:ring-2 focus:ring-green-500 focus:border-transparent text-lg transition-all duration-200"
                />
              ...
              <div class="space-y-2">
                ...
                <input
                  ...
                  type="text"
                  readonly
                  class="w-full px-4 py-3 border border-gray-300 rounded-xl bg-gray-50 focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 text-lg"
                />
              ...
              <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
                ...
                <button
                  ...
                  class="flex-1 px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all duration-200 font-semibold flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
        ...
        <!-- Help Section -->
        <div class="mt-8 bg-green-50/80 backdrop-blur-sm rounded-xl p-6 border border-green-200">
          <div class="flex items-start gap-4">
            ...
            <div>
              <h3 class="text-lg font-semibold text-green-800 mb-2">Tips Pengisian Form</h3>
              <ul class="text-green-700 space-y-1 text-sm">
                <li>• <strong>Deskripsi:</strong> Isi nama tindakan medis yang jelas</li>
                <li>• <strong>Status:</strong> Pilih “Aktif” jika digunakan</li>
                <li>• <strong>Tanggal:</strong> Otomatis tanggal hari ini</li>
                <li>• <strong>Update By:</strong> Nama pengguna otomatis</li>
              </ul>
            </div>
          </div>
        </div>
