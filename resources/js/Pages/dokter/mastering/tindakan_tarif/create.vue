  ...
  <AuthenticatedLayout>
    ...
    <div class="min-h-screen bg-cover bg-center p-6" style="background-image: url('/images/bg-login.png')">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-gray-600 text-lg">Tambahkan data tarif tindakan medis baru ke sistem</p>
      </div>
        ...
        <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
          ...
          <div class="bg-gradient-to-r from-yellow-400 to-amber-500 px-8 py-6 text-white">
            <div class="flex items-center gap-4">
              ...
              <div>
                <h2 class="text-2xl font-bold">Form Tambah Tindakan Tarif</h2>
                <p class="text-yellow-100">Lengkapi informasi tarif tindakan medis di bawah ini</p>
              </div>
            </div>
          </div>
