    ...
    <div class="min-h-screen bg-gray-50 py-6">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-3">
                ...
                <div>
                  <h1 class="text-2xl font-bold text-gray-900">Data Tindakan Tarif</h1>
                  <p class="text-sm text-gray-600">Kelola tarif tindakan medis berdasarkan eselon</p>
                </div>
              </div>
              <button
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr v-for="(record, idx) in records" :key="record.id" class="hover:bg-gray-50">
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    {{ (props.tindakanTarifs.current_page - 1) * props.tindakanTarifs.per_page + idx + 1 }}
                  </td>
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div class="flex items-center space-x-2">
                      <button
                        @click="showTindakanTarif(record.id)"
          ...
          <!-- Pagination -->
          <div v-if="props.tindakanTarifs.links && props.tindakanTarifs.links.length > 3" class="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
            <div class="flex-1 flex justify-between sm:hidden">
              <Link
                v-if="props.tindakanTarifs.links[0].url"
                :href="props.tindakanTarifs.links[0].url"
                class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"
              >
                Previous
              </Link>
              <Link
                v-if="props.tindakanTarifs.links[props.tindakanTarifs.links.length - 1].url"
                :href="props.tindakanTarifs.links[props.tindakanTarifs.links.length - 1].url"
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              <div>
                <p class="text-sm text-gray-700">
                  Menampilkan
                  <span class="font-medium">{{ (props.tindakanTarifs.current_page - 1) * props.tindakanTarifs.per_page + 1 }}</span>
                  sampai
                  <span class="font-medium">{{ Math.min(props.tindakanTarifs.current_page * props.tindakanTarifs.per_page, props.tindakanTarifs.total) }}</span>
                  dari
                  <span class="font-medium">{{ props.tindakanTarifs.total }}</span>
                  hasil
                </p>
              </div>
              <div>
