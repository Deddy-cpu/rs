...
// Filter state - default to laboratorium
const selectedService = ref(props.filters.kunjungan || 'laboratorium')
...
const currentServiceInfo = computed(() => {
  return serviceTypes[selectedService.value] || serviceTypes.laboratorium
})
...
function applyFilters() {
  ...
  const routeName = routeMap[selectedService.value] || 'dokter.poli_layanan.laboratorium'
...
function clearFilters() {
  searchQuery.value = ''
  dateFilter.value = ''
  selectedService.value = 'laboratorium'
  router.get(route('dokter.poli_layanan.laboratorium'))
}
