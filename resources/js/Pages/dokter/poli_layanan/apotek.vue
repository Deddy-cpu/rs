...
// Filter state - default to apotek
const selectedService = ref(props.filters.kunjungan || 'apotek')
...
const currentServiceInfo = computed(() => {
  return serviceTypes[selectedService.value] || serviceTypes.apotek
})
...
function applyFilters() {
  ...
  const routeName = routeMap[selectedService.value] || 'dokter.poli_layanan.apotek'
...
function clearFilters() {
  searchQuery.value = ''
  dateFilter.value = ''
  selectedService.value = 'apotek'
  router.get(route('dokter.poli_layanan.apotek'))
}
