...
// Filter state - default to gigi
const selectedService = ref(props.filters.kunjungan || 'gigi')
...
const currentServiceInfo = computed(() => {
  return serviceTypes[selectedService.value] || serviceTypes.gigi
})
...
function applyFilters() {
  ...
  const routeName = routeMap[selectedService.value] || 'dokter.poli_layanan.poli_gigi'
...
function clearFilters() {
  searchQuery.value = ''
  dateFilter.value = ''
  selectedService.value = 'gigi'
  router.get(route('dokter.poli_layanan.poli_gigi'))
}
