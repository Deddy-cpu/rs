...
// Filter state - default to kia
const selectedService = ref(props.filters.kunjungan || 'kia')
...
const currentServiceInfo = computed(() => {
  return serviceTypes[selectedService.value] || serviceTypes.kia
})
...
function applyFilters() {
  ...
  const routeName = routeMap[selectedService.value] || 'dokter.poli_layanan.kia'
...
function clearFilters() {
  searchQuery.value = ''
  dateFilter.value = ''
  selectedService.value = 'kia'
  router.get(route('dokter.poli_layanan.kia'))
}
