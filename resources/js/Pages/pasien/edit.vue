...
<template>
  <AuthenticatedLayout>
    ...
    <div class="container mx-auto max-w-xl p-6">
      <div class="mb-6">
        <h1 class="text-2xl font-bold text-blue-700">Edit Data Pasien</h1>
        <p class="text-sm text-gray-500 mt-1">Perbarui informasi pasien berikut.</p>
      </div>
      <form @submit.prevent="submitForm" class="bg-white rounded-lg shadow p-6 space-y-4">
        ...
        <div class="flex gap-2 mt-6">
          ...
          <button type="button" @click="resetForm" class="bg-gray-200 hover:bg-gray-300 text-gray-800 px-5 py-2 rounded transition">
            Reset
          </button>
