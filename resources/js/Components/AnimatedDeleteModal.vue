      ...
      <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
        ...
        >
          ...
          >
            ...
            <div class="bg-gradient-to-r from-red-500 via-pink-500 to-red-600 px-6 py-6 relative overflow-hidden">
              ...
              <div class="relative flex items-center">
                ...
                <div class="ml-4">
                  ...
                  <p class="text-red-100 text-sm font-medium">{{ subtitle }}</p>
                </div>
              </div>
            </div>
            ...
            <div class="px-6 py-8">
              <div class="flex items-start">
                ...
                <div class="ml-6 flex-1">
                  <p class="text-gray-800 text-lg leading-relaxed font-medium" v-html="message">
                  </p>
                  
                  <!-- Enhanced additional info -->
                  <div v-if="additionalInfo" class="mt-6 p-5 bg-gradient-to-r from-yellow-50 to-orange-50 border border-yellow-200 rounded-2xl shadow-sm">
                    <div class="flex">
                      <div class="flex-shrink-0">
                      ...
                      <div class="ml-4">
                        <p class="text-sm text-yellow-800 font-medium">{{ additionalInfo }}</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-6 flex flex-col sm:flex-row sm:justify-end sm:space-x-4 space-y-3 sm:space-y-0">
              <button
                type="button"
                @click="onCancel"
                :disabled="loading"
              ...
              <button
                ...
                @click="onConfirm"
                :disabled="loading"
                class="w-full sm:w-auto inline-flex justify-center items-center px-6 py-3 border border-transparent shadow-sm text-sm font-semibold rounded-xl text-white bg-gradient-to-r from-red-600 via-red-500 to-pink-600 hover:from-red-700 hover:via-red-600 hover:to-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 transform hover:scale-105 hover:shadow-xl"
              >
